...
CXXFLAGS = -O0 -Wall -g
LDFLAGS = -lutil
OBJECTS = Analyzer.o Announce.o Connection.o Coordinate.o Item.o ItemTracker.o Local.o Map.o Monster.o MonsterTracker.o Player.o Point.o Request.o Saiph.o Stash.o Telnet.o World.o
